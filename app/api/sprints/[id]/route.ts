...
import { checkTopPerformer } from '@/lib/utils/achievementService';
...
export async function PUT(
  ...
  try {
    ...
    // Check for top performer when sprint is marked as completed
    if (body.status === 'completed' && existingSprint.status !== 'completed') {
      await checkTopPerformer(id);
    }
